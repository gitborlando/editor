function randomNum(minNum: number, maxNum?: number): number {
  ...
  switch (arguments.length) {
    ...
    case 2:
      if (maxNum! < minNum) {
        throw new Error('maxNum 不能小于 minNum')
      }
...
class RandomName {
  ...
  getNickHeader(): string {
    if (this.nickHeader.length === 0) {
      throw new Error('nickHeader 数组为空')
    }
    return this.nickHeader[randomNum(0, this.nickHeader.length - 1)]
  }

  getNickFoot(): string {
    if (this.nickFoot.length === 0) {
      throw new Error('nickFoot 数组为空')
    }
  ...
  getFemaleName(sur: boolean = true): string {
    if (this.femaleNameItems.length === 0) {
      throw new Error('femaleNameItems 数组为空')
    }
  ...
  getMaleName(sur: boolean = true): string {
    if (this.maleNameItems.length === 0) {
      throw new Error('maleNameItems 数组为空')
    }
  ...
  getName(sur: boolean = true): string {
    if (this.allName.length === 0) {
      throw new Error('allName 数组为空')
    }
...
export const nickName = new RandomName()
