...
import { rcos, rsin } from 'src/editor/math/base'
...
import { PIXI, Pixi } from 'src/editor/stage/pixi'
...
import { createMultiLineHitArea } from 'src/shared/utils/pixi/line-hit-area'
import { useMemoComp } from 'src/shared/utils/react'

type ITransformComp = {}

export const TransformComp: FC<ITransformComp> = ({}) => {
  const { needDraw } = StageWidgetTransform
  ...
  return needDraw.value && <TransformContentComp />
}
