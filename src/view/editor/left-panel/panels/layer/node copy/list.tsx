...
export const NodeListComp: FC<INodeListComp> = ({}) => {
  ...
  const { nodeViewHeight, nodeListHeight, nodeScrollHeight } = UILeftPanelLayer
  const { nodeScrollShift, inViewNodeInfo: nodeIdsInView, calcNodeListChange } = UILeftPanelLayer
